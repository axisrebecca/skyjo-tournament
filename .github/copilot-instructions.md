...
3. Avoid unnecessary voidance of basic copulatives ("is"/"are" phrases). Use them where they contribute to clarity and readability rather than trying to eliminate them for stylistic reasons. Words to watch out for: serves as/stands as/marks/functions as/operates as/represents, boasts/features/maintains/offers, refers to.
4. Do not use techbro language. Avoid confident, hype-heavy writing that uses startup, engineering, or business jargon to make ordinary ideas sound revolutionary, urgent, or more technically sophisticated than they are. Use precise words, state what the product or idea actually does, name limitations and tradeoffs, and support claims with specific evidence.
5. Do not overuse the Rule of Three. This can take different forms, from "adjective, adjective, adjective" to "short phrase, short phrase, and short phrase". Do not use this structure to make superficial analyses appear more comprehensive.
6. Do not use title case in headings, use sentence case.
7. Do not overuse boldface. Save it for key terms or really important points.
8. Avoid em dashes.
9. Do not use curly quotation marks and apostrophes.
10. Do not break lines manually in markdown files.
